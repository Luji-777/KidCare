...
class PaymentController extends Controller
{
    ...
    public function getSummary($appointment_id)
    {
        ...
        if ($appointmentData) {
            ...
            $department_name = __('messages.' . strtolower($appointment->doctor->department->name));
                    ...
                    if (!$alreadyExists) {
                        ...
                        try {
                            ...
                            DBNotification::create([
                                'parent_id' => $parent->id,
                                'title' => __('messages.notification_appointment_confirmed_title'),
                                'message' => __('messages.notification_appointment_confirmed_body')
                            ]);
